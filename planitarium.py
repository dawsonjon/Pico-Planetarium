...
def plot_direction(stars, constellations, alt, az, field):
  ...
  for points in constellations:
    ...
    #plot points
    ax.plot([az for alt, az in points], [alt for alt, az in points], "b-")
  ...
  for alt, az, magnitude in stars:
    plt.plot(az, alt, ".w", markersize=(1+maglimit-magnitude)/2)
